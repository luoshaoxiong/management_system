  ...
  <div class="filter-bar">
    <div class="radio-group">
      <div class="form-line clearfix">
        ...
        <el-radio-group v-model="data.classification" size="small">
      ...
      <div class="form-line clearfix">
        ...
        <el-radio-group v-model="data.status" size="small">
          <el-radio-button :label="-1">全部</el-radio-button>
    ...
    <div class="search-input">
      <el-input :placeholder="placeholders[data.searchType]" v-model="data.searchWord" class="input-with-select" @keyup.enter.native="changeFilter">
        ...
        <span slot="suffix" class="search-icon el-input__icon el-icon-search" @click="changeFilter"></span>
      </el-input>
    </div>
  </div>
</template>
